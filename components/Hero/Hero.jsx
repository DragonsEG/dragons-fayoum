...
function Hero() {
    ...
    <span className="text-purple-400/70 hover:underline duration-300  grid place-content-center">{News.content}</span>
            ...
            <div className=" max-w-[1400px] container_3d sm:mt-10  md:mt-3 lg:-mt-20  relative  m-auto flex justify-center">
                <Image style={{ fontFamily: "interV" }} className={`${" absolute z-40 top-12 filter "} ${Styles.Drag3DBoubce}`} src={"/Identity/Images/drag_3d_color.png"} alt='Header Image' height='1160' width='1240' placeholder='blur' blurDataURL={`/_next/image?url=/ico/S1.png&w=16&q=1`} priority />
